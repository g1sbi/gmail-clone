...
<div class={`${fullscreen ? "fixed inset-0 z-10 flex justify-center items-center bg-gray-500 bg-opacity-75" : "bg-opacity-0"}`}>
	<div class={`z-10 flex flex-col bg-white border rounded-t-lg drop-shadow-2xl ${ minimize ? "w-72 h-10" : "w-[37.5rem] h-[38.5rem]"} ${ fullscreen ? "relative w-[100rem] h-[52rem]" : "fixed bottom-0 right-0 mr-[4.5rem]"  }`}>
		<!-- header -->
